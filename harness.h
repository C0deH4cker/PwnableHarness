...
typedef struct server_options {
	const char* user;            /*!< Username of the account to run child processes as */
...
/*! Starts a forking socket server after parsing command line arguments to perform configuration changes
